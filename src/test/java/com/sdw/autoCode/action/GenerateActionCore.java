package com.sdw.autoCode.action;
...
public class GenerateActionCore {
	...
	private static String include = "PlanDynamicVoice";
	private static String exclude = "";
	
	//action 所在包
	private static String package_name = "com.sdw";
	...
	public static void generateSource(Class codeclass, String packageName,
		...
		filePath.append(basePath).append("\\src\\main\\java").append("\\").append(tempName)
				.append("\\").append("action");
		String file = createFile(filePath.toString(), (new StringBuilder(
				class_name)).append("Controller").append(".java").toString());
		StringBuffer templatePath = new StringBuffer();
		templatePath.append(base_name).append("\\src\\")
				.append("test\\java\\autoCode\\action").append("\\")
